...
class CIFAR10(object):
    """CIFAR-10 data module used for AL loop.

    Builds three loaders:
      - trainloader: labeled indices from known classes (ID only)
      - unlabeledloader: remaining pool (includes unknown-class indices)
      - testloader: filtered to known classes when is_filter=True

    If is_mini=True, only a percent of known-class data are initially labeled
    (controlled by init_percent).
    """
